...
function FuncionarioLayout() {
    return (<drawer_1.Drawer screenOptions={{
            ...
            drawerIcon: function (_a) {
                var color = _a.color;
                return <vector_icons_1.Feather name="user" size={20} color={color}/>;
            },
        }}/>
            ...
            drawerIcon: function (_a) {
                var color = _a.color;
                return <vector_icons_1.Feather name="clock" size={20} color={color}/>;
            },
        }}/>
...
exports.default = FuncionarioLayout;
